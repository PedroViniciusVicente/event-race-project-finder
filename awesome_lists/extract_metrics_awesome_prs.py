...
class GitHubPRMetricsCollector:
    ...
    def process_pr_data(self, pr_data: Dict) -> Dict:
        ...
        if merged_date:
            time_to_merge = (merged_date - created_date).total_seconds() / 3600
        
        if closed_date:
            time_to_close = (closed_date - created_date).total_seconds() / 3600
...
def main():
    ...
    input_file = "awesome_lists/awesome_list_prs_filtered.json"
    output_file = "awesome_lists/awesome_list_final_dataset.csv"
