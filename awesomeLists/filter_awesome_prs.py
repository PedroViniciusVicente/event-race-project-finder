...
class GitHubPRAnalyzer:
    ...
    def analyze_all_repositories(self, json_file: str, output_file: str = 'awesomeLists/awesome_list_prs_filtered.json'):
...
def main():
    ...
    repos_file = 'awesomeLists/awesome_list_projects_url.json'
